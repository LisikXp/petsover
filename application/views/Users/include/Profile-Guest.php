			...
			<div class="col-sm-6 col-sm-6-custom">
				...
				<?php if ($mypage == $uid) {
					if ($name == null || $_SESSION['family']) {
						$popup = "add-single-dog-popup";
					} else{
						$popup = "add-a-family-popup";
					} ?>
					<div class="tile">
						<div class="welcome">
							...
							<div class="welcome-button">
								<a href="#" class="link button button-cta-green contest-button popup-trigger" data-popup-id="<?= $popup;?>">+ Add a pet</a>
							</div>
						</div>
					</div>
					<?php } ?>
